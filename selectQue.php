...
<body>
<div id="dispQuestion">
<input onclick="responsiveVoice.speak(quest, 'UK English Female', { rate: 0.75,pitch: .8});" type="button" value="Play" /><br>
</div>
</body>
</html>
