...
if (isset($_POST['submit'])) {
    if (empty($_POST['email']) || empty($_POST['spass'])) {
        ...
        $sql = "select * from teachers where tpassword='$password' AND email='$username'";
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" method="post" action="questions.php">
        <h2 class="form-signin-heading">Teachers Login</h2>
